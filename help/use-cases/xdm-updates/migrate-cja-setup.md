...
1. Check the corresponding new field in the [Chapter offset](/help/reporting/variables/dimensions/chapters/chapter-offset.md) article.
...
1. Populate the [!UICONTROL **If**] clause using the value of the **Reporting XDM Field Path**, as shown on the [Chapter name](/help/reporting/variables/dimensions/chapters/chapter-name.md) page.
...
1. Check the corresponding new field in the [Content Name](/help/reporting/variables/dimensions/core/content-name.md) article.
