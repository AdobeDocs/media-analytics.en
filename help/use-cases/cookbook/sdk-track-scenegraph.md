...
|  MediaHeartbeat Constants  | Refer to the constants on this page: <br/><br/>[Media Heartbeat Methods.](/help/use-cases/track-av-playback/track-core/track-core-roku.md)  | Use these constants with MediaHeartbeat APIs  |
|  Standard Metadata  | Refer to the constants on this page: <br/><br/>[Standard Metadata Parameters.](/help/use-cases/track-av-playback/impl-std-metadata/impl-std-metadata-roku.md)  | Use these constants to attach Standard Video/Ad metadata in MediaHeartbeat APIs  |
