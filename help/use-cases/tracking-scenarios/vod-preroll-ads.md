...
| The content plays.  | | Content Heartbeats | This network call is identical to the [VOD playback with no ads](/help/use-cases/tracking-scenarios/vod-no-intrs-details.md) scenario.  |
| The content is complete.  | `trackComplete` | Heartbeat Content Complete | This network call is identical to the [VOD playback with no ads](/help/use-cases/tracking-scenarios/vod-no-intrs-details.md) scenario.  |
