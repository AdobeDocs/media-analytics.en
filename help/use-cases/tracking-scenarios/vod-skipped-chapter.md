...
This is the same scenario as [VOD playback with one chapter](/help/use-cases/tracking-scenarios/vod-one-chapter.md), except the user in this case intends to seek out of the chapter thereby skipping it to land into main content. 
...
The parameters used during chapter playback are identical to the parameters in the [VOD playback with one chapter](/help/use-cases/tracking-scenarios/vod-one-chapter.md) scenario, except that there is no chapter complete network call.
