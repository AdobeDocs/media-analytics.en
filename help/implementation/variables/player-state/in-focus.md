...
*This page covers data collection for the **In focus** player state. See [Streams impacted by in focus](/help/reporting/variables/metrics/player-state/in-focus-streams-impacted.md), [In focus counts](/help/reporting/variables/metrics/player-state/in-focus-count.md), and [In focus total duration](/help/reporting/variables/metrics/player-state/in-focus-total-duration.md) for the corresponding reporting metrics.*
