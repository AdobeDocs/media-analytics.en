...
*This page covers data collection for the **Genre** variable. See [Genre](/help/reporting/variables/dimensions/genre.md) for the corresponding reporting dimension.*
