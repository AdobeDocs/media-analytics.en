...
*This page covers data collection for the **Ad player name** variable. See [Ad player name](/help/reporting/variables/dimensions/ads/ad-player-name.md) for the corresponding reporting dimension.*
