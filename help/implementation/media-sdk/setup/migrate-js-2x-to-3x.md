---
title: Migrate from JavaScript SDK 2.x to 3.x
description: Code comparison and migration guide for upgrading from the Media SDK JavaScript 2.x to the 3.x SDK.
