...
---
# Begin the Streaming Media implementation
<!-- Do all of the sections here apply to any type of implementation method? I think so... -->

{{release-limited-testing}}

Regardless of which [implementation path](/help/implementation/overview.md) you choose for configuring media tracking, begin the implementation by completing the following sections:
