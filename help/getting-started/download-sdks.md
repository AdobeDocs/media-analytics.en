...
| </br>**Web** | Adobe Analytics<p>Customer Journey Analytics</p><p>Adobe Journey Optimizer</p><p>Real-Time CDP</p> | Edge | Web - Experience Platform Edge |  |[Implement the Streaming Media Collection Add-on using the Edge Network](/help/implementation/edge/implementation-edge.md) <p>and</p><p>[Send Web data to Edge with the Adobe Experience Platform Web SDK](/help/implementation/edge/edge-web-sdk.md)</p> | |
