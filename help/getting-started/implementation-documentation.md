...
|:-----------------------:|----------------|
| **Web** | * [Set up the Web SDK for streaming media](/help/implementation/edge/web-sdk.md) <br> * [Set up JavaScript for streaming media](/help/implementation/analytics-only/javascript.md) <br>* [Web Implementation with Adobe Media Analytics for Audio and Video extension ](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/media-analytics-3x/overview.html?lang=en) |
| **Mobile**      | * [Set up iOS](/help/implementation/edge/ios.md) and [Android](/help/implementation/edge/android.md) for streaming media <br> *[Adobe Experience Platform Mobile SDK Guide](https://developer.adobe.com/client-sdks/documentation/) <br> *[Adobe Media Analytics for Audio and Video extension](https://developer.adobe.com/client-sdks/documentation/adobe-media-analytics/)<br> *[Current Mobile SDK Versions](https://developer.adobe.com/client-sdks/documentation/current-sdk-versions/)|
| **OTT**    | *[Chromecast 3.0 SDK for Adobe Marketing Cloud Solutions](https://adobe-marketing-cloud.github.io/media-sdks/reference/chromecast/)<br> * [Set up Roku for streaming media](/help/implementation/edge/roku.md) |
