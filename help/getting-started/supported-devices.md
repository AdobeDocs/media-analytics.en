...
For devices that don't currently have SDK support or in situations where you need to customize your implementation, you can use the Media Collection API or Media Edge API. These APIs allow you to make RESTful API calls directly from a device to the backend of Adobe streaming media services.
...
| Streaming Platforms and Devices |  | Edge Network collection libraries | Media Edge API | Analytics-only collection libraries | Media Collection API<br>(Analytics-only) |
|:---|:---|:---:|:---:|:---:|:---:|
| Web/Mobile Web | | | | | |
| | JavaScript browsers | ![Supported](/help/assets/icon-blue-check.png) | ![Supported](/help/assets/icon-blue-check.png) | ![Supported](/help/assets/icon-blue-check.png) | ![Supported](/help/assets/icon-blue-check.png) |
| Mobile App | | | | | |
