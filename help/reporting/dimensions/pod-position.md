...
| Adobe Analytics (classification) | Classification of the [Ad pod](ad-pod.md) dimension — Adobe automatically creates this classification when **[[!UICONTROL Media Ads]](/help/reporting/setup/analytics-reporting.md)** is enabled for the report suite. You are responsible for populating and maintaining classification values. |
