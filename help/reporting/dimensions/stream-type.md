...
The **Stream type** dimension captures whether each media session was audio or video content. It is available in Adobe Analytics once [Media Core is enabled](/help/reporting/setup/analytics-reporting.md) for the report suite, and in Customer Journey Analytics for any dataset that includes streaming media data.
...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.streamType` when [[!UICONTROL Media Core]](/help/reporting/setup/analytics-reporting.md) is enabled. |
