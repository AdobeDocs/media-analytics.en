...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.station` when [[!UICONTROL Audio Metadata]](/help/reporting/setup/analytics-reporting.md) is enabled. |
