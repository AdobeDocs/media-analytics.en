...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.contentType` when [[!UICONTROL Media Core]](/help/reporting/setup/analytics-reporting.md) is enabled. |
