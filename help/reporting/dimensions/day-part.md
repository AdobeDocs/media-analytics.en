...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.dayPart` when [[!UICONTROL Video Metadata]](/help/reporting/setup/analytics-reporting.md) is enabled. |
...
| Data feeds | `videodaypart`, `post_videodaypart` |
