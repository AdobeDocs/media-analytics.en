...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.season` when [[!UICONTROL Video Metadata]](/help/reporting/setup/analytics-reporting.md) is enabled. |
