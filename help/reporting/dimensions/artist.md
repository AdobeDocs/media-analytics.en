...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.artist` when [[!UICONTROL Audio Metadata]](/help/reporting/setup/analytics-reporting.md) is enabled. |
