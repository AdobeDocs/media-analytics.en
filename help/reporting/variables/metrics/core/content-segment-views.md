...
The **Content segment views** metric counts five-minute content segments in which active main-content playback occurred. The metric confirms that the viewer played content in that segment rather than just loading or buffering. Pair it with the [Content segment](/help/reporting/variables/dimensions/core/content-segment.md) dimension to break down which portions of long-form content viewers actually consumed.
