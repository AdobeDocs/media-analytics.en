...
| Data feeds | `videoaverageminuteaudience` |

>[!IMPORTANT]
>
>Average minute audience requires a non-zero [Content length](/help/reporting/variables/dimensions/core/content-length.md). If content length is unset or zero, this metric is not produced for the session.
