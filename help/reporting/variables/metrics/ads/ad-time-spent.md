...
The **Ad time spent** metric reports the total seconds of active ad playback per session, excluding pauses, buffering, and stalls. Pair it with [Content time spent](/help/reporting/variables/metrics/core/content-time-spent.md) to compare ad load against content engagement.
