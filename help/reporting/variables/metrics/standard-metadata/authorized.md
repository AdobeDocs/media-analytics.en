...
The **Authorized** metric counts sessions whose user has been authorized through Adobe Pass or TV-Everywhere. Pair with the [MVPD](/help/reporting/variables/dimensions/standard-metadata/mvpd.md) dimension to break out authentication volume by provider.
