...
The media backend increments this count on every [chapter start](/help/implementation/events/chapters/chapter-start.md) event received during the session. The metric is reported on the close call.
