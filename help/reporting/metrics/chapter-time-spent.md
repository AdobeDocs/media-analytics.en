...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.chapter.timePlayed` when [[!UICONTROL Media Chapters]](/help/reporting/setup/analytics-reporting.md) is enabled. |
