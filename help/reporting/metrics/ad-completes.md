...
The media backend sets this flag when an [ad complete](/help/implementation/events/ads/ad-complete.md) event is received. The metric is reported on the ad close call. Ads that are skipped or abandoned do not count as completions.

| Reporting system | Source |
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.ad.complete` when [[!UICONTROL Media Ads]](/help/reporting/setup/analytics-reporting.md) is enabled. |
