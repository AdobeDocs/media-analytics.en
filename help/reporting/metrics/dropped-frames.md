...
*This page covers the **Dropped frames** metric. Adobe Analytics auto-populates a paired [Dropped frames (dimension)](/help/reporting/dimensions/dropped-frames.md) from the same `a.media.qoe.droppedFrameCount` context data variable. Customer Journey Analytics exposes a single `xdm.mediaReporting.qoeDataDetails.droppedFrames` field that you can use as either a dimension or a metric. See [Dropped frames](/help/implementation/variables/quality/dropped-frames.md) for how to collect this variable.*
