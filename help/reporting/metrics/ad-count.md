...
The media backend increments this count on every [ad start](/help/implementation/events/ads/ad-start.md) event received during the session. The metric is reported on the close call.
