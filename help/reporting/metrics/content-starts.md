...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.play` when [[!UICONTROL Media Core]](/help/reporting/setup/analytics-reporting.md) is enabled. |
