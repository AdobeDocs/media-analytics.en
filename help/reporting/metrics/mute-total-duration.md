...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.states.mute.time` when [[!UICONTROL Player State Tracking]](/help/reporting/setup/analytics-reporting.md) is enabled. |
