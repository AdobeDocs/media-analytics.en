...
| --- | --- |
| Adobe Analytics | Automatically collected from context data `a.media.totalTimePlayed` when [[!UICONTROL Media Core]](/help/reporting/setup/analytics-reporting.md) is enabled. |
