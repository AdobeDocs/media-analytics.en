...
---
# Legacy Code comparison — 1.x to 2.x {#code-comparison-x-to-x}
...
For more information on tracking video with 2.x, see [Track Core Video Playback.](/help/use-cases/track-av-playback/track-core-overview.md)
