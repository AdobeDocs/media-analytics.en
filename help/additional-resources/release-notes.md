...
| Feature | Description | Targeted Date |
| ----------- | ---------- | ------- |
| Multiple Player State Tracking | Use the Media Collection API to implement multiple player state tracking. [Learn more](/help/use-cases/player-state-tracking/multiple-player-states.md) | September 2022 |
